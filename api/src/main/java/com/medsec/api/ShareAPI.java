 ...
 * Date: 2020-10-21
 * Description:
 * When a user is going to share the appointment to others, app is no longer sending request to the server,
 * app will use the mailing apps (e.g. Gmail) on the phones directly.
 */
@Deprecated
@Path("/")
public class ShareAPI {
    ...
    public Response shareAppointment(@Context SecurityContext sc, Mail mail) {
        ...
        String appDate = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(Date.from(app.getDate()));

        // avoid using String to do modification
        StringBuilder textHtmlStringBuilder = new StringBuilder();
        textHtmlStringBuilder.append("<h2>### Please do not reply this email ###\n");
        textHtmlStringBuilder.append("###This email is automatically generated by the system###</h2>");
        textHtmlStringBuilder.append("<h3>Title: " + app.getTitle() + "</h3>");
        textHtmlStringBuilder.append("<h3>Date: " + appDate + "</h3>");
        textHtmlStringBuilder.append("<h3>Detail: " + app.getDetail() + "</h3>");
        textHtmlStringBuilder.append("<h3>Note: " + app.getNote() + "</h3>");
        ...
        if (mail.getMailto() != null) {
            ...
            Email email = new EmailBuilder()
                              ...
                              .subject("[INFO] Sharing Appointment")
                              .textHTML(textHtmlStringBuilder.toString())
                              .build();
